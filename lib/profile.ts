...
export const SKILL_GROUPS: SkillCategory[] = [
  ...
  },
  {
    ...
    icon: "database",
    skills: ["PostgreSQL", "MySQL", "MongoDB", "Redis", "BigQuery"],
  },
  {
    id: "cloud",
    label: "Cloud & DevOps",
  ...
  },
  {
    ...
    description: "Event-driven plumbing between services.",
    icon: "message",
    skills: ["RabbitMQ", "Google Pub/Sub"],
  },
  {
    id: "testing",
    label: "Testing",
    description: "Catching regressions before users do.",
    icon: "flask",
    skills: ["Jest"],
  },
  {
...
export const PROJECTS: Project[] = [
  {
    slug: "carticom",
    title: "Carticom",
    tagline: "AI-native commerce operating system for Africa",
    description:
      "A multi-tenant commerce SaaS platform that helps African businesses create and manage online stores, products, inventory, orders, escrow payments, and fulfillment from one system — on a subscription model with zero transaction fees.",
    ...
    live: "https://carticom.vercel.app",
    status: "live",
    featured: true,
    year: "2026",
    highlights: [
      "Multi-tenant merchant architecture",
      "SaaS subscription model with zero transaction fees",
      "Escrow-powered buyer/seller transactions",
      "Paystack and Flutterwave payment integrations",
      "AI-powered commerce features",
      "Redis-backed services and PostgreSQL data layer",
    ],
  },
  {
    slug: "agentpay",
    title: "AgentPay",
    tagline: "AI-powered fintech payments for African businesses",
    description:
      "An AI-powered fintech payment platform designed to help African businesses process payment intents through automated payment workflows and backend orchestration.",
    ...
    featured: true,
    year: "2025",
    highlights: ["Payment intent processing", "Automated payment workflows", "Backend orchestration"],
  },
  {
    slug: "paymatch",
    title: "PayMatch",
    tagline: "Full-stack fintech payment platform",
    description:
      "A full-stack fintech payment platform built to manage and process payment workflows, connecting a modern frontend with backend services and a PostgreSQL database.",
    image: "/projects/paymatch.svg",
    stack: ["Next.js", "NestJS", "Node.js", "PostgreSQL"],
    github: "https://github.com/somod-gif/PayMatch-Backend",
    live: "https://paymatch-frontend.vercel.app",
    status: "live",
    featured: true,
    year: "2026",
    highlights: ["Payment workflow management & processing", "Modern frontend with Node.js backend services", "PostgreSQL data layer"],
  },
  {
    slug: "opportunity-ai",
    ...
    description:
      "A full-stack AI-powered platform designed to help users discover and navigate career and professional opportunities through an intelligent web experience.",
    image: "/projects/opportunity-ai.svg",
    stack: ["Next.js", "PostgreSQL"],
    github: "https://github.com/somod-gif/opportunity-ai",
    live: "https://opportunity-ai-snowy.vercel.app",
    status: "live",
    featured: false,
    year: "2026",
    highlights: ["Career & professional opportunity discovery", "Intelligent web experience", "AI-powered navigation"],
  },
  {
    slug: "mama-connect",
    title: "MamaConnect",
    tagline: "AI-assisted maternal health platform",
    description:
      "An AI-assisted maternal healthcare platform connecting pregnant women, Community Health Workers, and healthcare facilities — with WhatsApp, USSD, and SMS access for underserved Nigerian communities. Built for the HelpMum CareCode Hackathon on HelpMum's open-source innovations.",
    image: "/projects/mama-connect.svg",
    stack: ["Next.js", "NestJS", "PostgreSQL", "OpenAI", "HelpMum Open Source"],
    github: "https://github.com/somod-gif/mama-connect-demo",
    live: "https://mama-connect-demo.vercel.app",
    status: "live",
    featured: true,
    year: "2024",
    highlights: [
      "AI-powered maternal health risk detection",
      "WhatsApp, USSD and SMS access without smartphones",
      "Community Health Worker dashboard",
      "Real-time alerts for high-risk cases",
      "Multi-language support for Nigerian communities",
    ],
  },
  {
    slug: "quota-os",
    title: "QuotaOS",
    tagline: "API rate limiting & quota management",
    description:
      "A full-stack API rate-limiting and quota management platform designed to help developers control API usage, enforce limits, and manage application traffic.",
    image: "/projects/quota-os.svg",
    stack: ["Next.js", "Full Stack", "Supabase"],
    github: "https://github.com/somod-gif/Quota-OS",
    live: "https://quota-os-ten.vercel.app",
    status: "live",
    featured: false,
    year: "2026",
    highlights: ["Control API usage", "Enforce rate limits & quotas", "Manage application traffic"],
  },
  {
    slug: "meu-deliver",
    title: "Meu Deliver",
  ...
  {
    slug: "59minutes-print",
    title: "59Minutes Print",
    tagline: "Print-on-demand platform",
    description:
      "A print-on-demand platform for efficient browsing and checkout, with dynamic product rendering, product customization, and a multi-step checkout system.",
    image: "/projects/59minutes-print.svg",
    stack: ["Next.js", "TailwindCSS", "REST APIs", "Vercel"],
    live: "https://www.59minutesprint.com/",
    status: "live",
    featured: false,
    year: "2025",
  },
  {
    ...
    description:
      "An enterprise-grade fintech platform with secure dashboards, API-driven views, real-time integrations, and an enterprise authentication system.",
    image: "/projects/accessivo.svg",
    stack: ["React", "TailwindCSS", "REST APIs", "PostgreSQL"],
    live: "http://accessivo.io/",
    status: "live",
    featured: false,
    year: "2025",
  },
